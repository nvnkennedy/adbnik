...
The marketing/install pages live in **`site/`** (HTML + `assets/`). They are deployed with the **`pages`** workflow (`.github/workflows/pages.yml`), which uploads the **`site`** folder to **GitHub Pages**.
