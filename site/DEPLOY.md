...
4. Save. The workflow **pages** runs when you push changes under **`site/`**, **`docs/guide/`**, or **`docs/css/`** on **`main`** (distribution branch), or when you run it manually (**Actions** → **pages** → **Run workflow**). See **[`BRANCHES.md`](../BRANCHES.md)**.
