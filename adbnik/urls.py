"""Public web links for Adbnik (Help menu, About dialog).

Keep these strings in one place so the UI and future docs stay aligned.
"""
...
GITHUB_REPO = "https://github.com/nvnkennedy/adbnik"
PYPI_PROJECT = "https://pypi.org/project/adbnik/"
